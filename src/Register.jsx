    ...
    <div className="row gy-4 align-items-center">
      <div className="col-12 col-md-6 col-xl-7">
        <div className="d-flex justify-content-center text-bg-primary">
          <div className="col-12 col-xl-9">
            ...
            <p className="lead mb-5">Register to view the project</p>
      ...
      <div className="col-12 col-md-6 col-xl-5 ">
        <div className="card border-0 rounded-4">
          <div className="card-body p-3 p-md-4 p-xl-5 bg-white">
            <div className="row">
            ...
            <form action="#!" onSubmit={handleSubmit}>
              <div className="row gy-3 overflow-hidden">
                ...
                <div className="col-12">
                  <div className="form-floating mb-3">
                    <input type="password" value={confirmPassword} onChange={(event) => setConfirmPassword(event.target.value)} className="form-control" name="email" id="confirmpass" placeholder="name@example.com" required/>
